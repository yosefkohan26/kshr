...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = [
    ...
    { path: "/blog/introducing-kshr", lastModified: "2026-02-12", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/zen-of-kshr", lastModified: "2026-02-27", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/kshr-claude-teams", lastModified: "2026-03-30", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/kshr-omo", lastModified: "2026-03-30", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/kshr-ssh", lastModified: "2026-03-30", changeFrequency: "monthly" as const, priority: 0.7 },
