...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "blog.introducingKshr" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "kshr", "terminal", "macOS", "Ghostty", "libghostty",
    ...
    alternates: buildAlternates(locale, "/blog/introducing-kshr"),
  };
}

export default function IntroducingKshrPage() {
  const t = useTranslations("blog.posts.introducingKshr");
