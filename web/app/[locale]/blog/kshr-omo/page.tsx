...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "blog.kshrOmo" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "kshr", "OpenCode", "oh-my-opencode", "oh-my-openagent", "tmux",
    ...
    alternates: buildAlternates(locale, "/blog/kshr-omo"),
  };
}

export default function KshrOmoPage() {
  const t = useTranslations("blog.posts.kshrOmo");
