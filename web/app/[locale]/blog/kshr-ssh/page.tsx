...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "blog.kshrSsh" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "kshr", "SSH", "remote development", "terminal", "macOS",
    ...
    alternates: buildAlternates(locale, "/blog/kshr-ssh"),
  };
}

export default function KshrSshPage() {
  const t = useTranslations("blog.posts.kshrSsh");
  ...
  return (
    <>
      ...
      <video
        src="/blog/kshr-ssh-image-upload.mp4"
        width={1824}
        height={1080}
        autoPlay
        loop
      ...
      <ul className="mt-4 space-y-1">
        ...
        <li><code>kshr claude-teams</code> and <code>kshr omo</code> work over SSH, spawning teammate panes locally while computation runs remote</li>
