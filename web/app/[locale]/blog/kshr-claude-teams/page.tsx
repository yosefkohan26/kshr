...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "blog.kshrClaudeTeams" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "kshr", "Claude Code", "agent teams", "teammate mode", "tmux",
    ...
    alternates: buildAlternates(locale, "/blog/kshr-claude-teams"),
  };
}

export default function KshrClaudeTeamsPage() {
  const t = useTranslations("blog.posts.kshrClaudeTeams");
