...
export const metadata: Metadata = {
  title: "Privacy Policy — kshr",
  description: "Privacy policy for kshr",
  alternates: { canonical: "https://kshr.com/privacy-policy" },
};
  ...
  return (
    <>
      ...
      <p>
        ...
        <a href="https://kshr.com">kshr.com</a>.
        &ldquo;Application&rdquo; refers to the kshr desktop application for
