...
export const metadata: Metadata = {
  title: "EULA — kshr",
  description: "End-User License Agreement for kshr",
  alternates: { canonical: "https://kshr.com/eula" },
};
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>&ldquo;Application&rdquo;</strong> means the kshr desktop
