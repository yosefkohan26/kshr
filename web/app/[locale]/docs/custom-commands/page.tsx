...
export default function CustomCommandsPage() {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          <strong>{t("localConfig")}</strong> <code>./kshr.json</code> &mdash; {t("localConfigDesc")}
        </li>
        <li>
          <strong>{t("globalConfig")}</strong> <code>~/.config/kshr/kshr.json</code> &mdash; {t("globalConfigDesc")}
        </li>
      </ul>
      ...
      <h2>{t("schema")}</h2>
      <p>{t("schemaDesc")}</p>
      <CodeBlock title="kshr.json" lang="json">{`{
  "commands": [
    {
      "name": "Start Dev",
      "keywords": ["dev", "start"],
                ...
                "surfaces": [
                  {
                    "type": "terminal",
                    "name": "Events",
                    "command": "tail -f /tmp/kshr-debug.log",
                    "focus": true
                  }
                ]
              }
