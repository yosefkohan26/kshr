...
export default function ClaudeCodeTeamsPage() {
  ...
  return (
    <>
      ...
      <video
        src="/blog/kshr-claude-teams-demo.mp4"
        width={1824}
        height={1080}
        autoPlay
        loop
      ...
      <h2>{t("usage")}</h2>
      <CodeBlock lang="bash">{`kshr claude-teams
kshr claude-teams --continue
kshr claude-teams --model sonnet`}</CodeBlock>
      <p>{t("usageDesc")}</p>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>~/.kshrterm/claude-teams-bin/</code></td><td>{t("dirShim")}</td></tr>
