    ...
    features: [
      {
        title: "SSH",
        description:
          "kshr ssh user@remote creates a workspace for a remote machine. Browser panes route through the remote network so localhost just works. Drag an image into a remote session to upload via scp. Coding agent notifications come home to your local sidebar. Reconnects on drops.",
      },
      {
        title: "Claude Code Teams",
        description:
          "kshr claude-teams launches Claude Code's experimental teammate mode with one command. It sets up the environment, fakes a tmux session, and translates tmux commands into native kshr splits. Teammates stack vertically in a right column with sidebar metadata and notifications.",
      },
      {
        title: "oh-my-openagent",
        description:
          "kshr omo integrates oh-my-openagent (formerly oh-my-opencode), which orchestrates specialist agents across Claude, GPT, and Gemini in parallel. Same tmux shim as claude-teams, auto-installs the plugin, notifications route through kshr.",
      },
      {
        title: "Browser Profile Import",
        description:
          "Import cookies, history, and sessions from Chrome, Arc, Brave, Firefox, Safari, and 20+ browsers. The import wizard detects installed browsers, lets you pick profiles, and injects everything into kshr's browser panes so you're already logged in.",
      },
      {
        title: "Minimal Mode",
        description:
      ...
      },
      {
        ...
        description:
          "Define project-specific actions in kshr.json that launch from the command palette. One file per repo, no global config needed.",
      },
    ],
  },
  "0.62.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Browser panels now support Cmd+F with inline find controls, so you can search long docs, dashboards, and issue threads without leaving kshr.",
      },
      {
        title: "Vi Copy Mode",
        description:
      ...
      },
      {
        ...
        description:
          "kshr now includes Japanese plus 16 additional languages, and a per-app language override lets you change the UI language without changing macOS system settings.",
      },
    ],
  },
  "0.61.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Hit Cmd+Shift+P to open a searchable command palette. Every action in kshr is here: creating workspaces, toggling the sidebar, checking for updates, switching windows. Keyboard shortcuts are shown inline so you can learn them as you go.",
  ...
  "0.60.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The embedded browser now has full WebKit DevTools. Open them with the standard shortcut and they persist across tab switches. Inspect elements, debug JavaScript, and monitor network requests without leaving kshr.",
