...
export default function SshPage() {
  ...
  return (
    <>
      ...
      <h2>{t("usage")}</h2>
      <CodeBlock lang="bash">{`kshr ssh user@remote
kshr ssh user@remote --name "dev server"
kshr ssh user@remote -p 2222
kshr ssh user@remote -i ~/.ssh/id_ed25519`}</CodeBlock>
      <p>{t("usageDesc")}</p>
