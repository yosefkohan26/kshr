...
final class SidebarHelpMenuUITests: XCTestCase {
    ...
    func testHelpMenuOpensKeyboardShortcutsSection() {
        ...
        app.launchEnvironment["KSHR_UI_TEST_MODE"] = "1"
    ...
    func testHelpMenuCheckForUpdatesTriggersSidebarUpdatePill() {
        let app = XCUIApplication()
        app.launchEnvironment["KSHR_UI_TEST_MODE"] = "1"
        app.launchEnvironment["KSHR_UI_TEST_FEED_URL"] = "https://kshr.test/appcast.xml"
        app.launchEnvironment["KSHR_UI_TEST_FEED_MODE"] = "available"
        app.launchEnvironment["KSHR_UI_TEST_UPDATE_VERSION"] = "9.9.9"
        app.launchEnvironment["KSHR_UI_TEST_AUTO_ALLOW_PERMISSION"] = "1"
        launchAndActivate(app)
    ...
    func testHelpMenuSendFeedbackOpensComposerSheet() {
        ...
        XCTAssertTrue(
            app.staticTexts[
                "A human will read this! You can also reach us at founders@yosefkohan26.com."
...
final class FeedbackComposerShortcutUITests: XCTestCase {
    ...
    func testCmdOptionFWorksFromSettingsWindow() {
        let app = XCUIApplication()
        app.launchEnvironment["KSHR_UI_TEST_MODE"] = "1"
        app.launchEnvironment["KSHR_UI_TEST_SHOW_SETTINGS"] = "1"
        app.launch()
        app.activate()
...
final class CommandPaletteAllSurfacesUITests: XCTestCase {
    ...
    private let hiddenSurfaceToken = "kshr-command-palette-hidden-surface"
    private let visibleSurfaceToken = "kshr-command-palette-visible-surface"
    private let noMatchWorkspaceQuery = "kshr-command-palette-no-match"

    override func setUp() {
        super.setUp()
        continueAfterFailure = false
        socketPath = "/tmp/kshr-ui-test-command-palette-\(UUID().uuidString).sock"
    ...
    func testMinimalModeToggleKeepsSettingsWindowFocused() throws {
        let app = XCUIApplication()
        let diagnosticsPath = "/tmp/kshr-ui-test-settings-focus-\(UUID().uuidString).json"
        ...
        let diagnostics = waitForDiagnostics(
            ...
            data["keyWindowIdentifier"] == "kshr.settings" && data["settingsWindowIsKey"] == "1"
        }
