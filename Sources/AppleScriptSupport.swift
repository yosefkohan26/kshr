...
extension NSApplication {
    var isAppleScriptEnabled: Bool {
        // kshr always enables AppleScript — the underlying Ghostty fork
...
final class ScriptTab: NSObject {
    ...
    private var workspace: Workspace? {
        state?.tabManager.tabsById[tabId]
    }
...
final class ScriptTerminal: NSObject {
    ...
    private var workspace: Workspace? {
        state?.tabManager.tabsById[workspaceId]
    }
...
@MainActor
@objc(KshrScriptInputTextCommand)
