...
enum KeyboardShortcutSettings {
    static let didChangeNotification = Notification.Name("kshr.keyboardShortcutSettingsDidChange")
    static let actionUserInfoKey = "action"
    static let settingsFileDisplayPath = "~/.config/kshr/settings.json"
    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var label: String {
            ...
            case .quit: return String(localized: "menu.quitKshr", defaultValue: "Quit kshr")
