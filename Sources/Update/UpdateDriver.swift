...
class UpdateDriver: NSObject, SPUUserDriver {
    ...
    func show(_ request: SPUUpdatePermissionRequest,
        ...
        if env["KSHR_UI_TEST_TRIGGER_UPDATE_CHECK"] == "1" || env["KSHR_UI_TEST_AUTO_ALLOW_PERMISSION"] == "1" {
...
#endif
        // Never show Sparkle's permission UI. kshr always enables scheduled checks and keeps
    ...
    func showUpdateReleaseNotes(with downloadData: SPUDownloadData) {
        // kshr uses Sparkle's UI for release notes links instead.
    }
    ...
    func showUpdateInFocus() {
        // No-op; kshr never shows Sparkle dialogs.
    }
