...
enum UpdateFeedResolver {
    static let fallbackFeedURL = "https://github.com/yosefkohan26/kshr/releases/latest/download/appcast.xml"
...
extension UpdateDriver: SPUUpdaterDelegate {
    ...
    func feedURLString(for updater: SPUUpdater) -> String? {
        ...
        if let override = env["KSHR_UI_TEST_FEED_URL"], !override.isEmpty {
        ...
        // - kshr NIGHTLY has the nightly appcast URL injected by CI
