...
final class UpdateLogStore {
    ...
    private let queue = DispatchQueue(label: "kshr.update.log")
    ...
    private init() {
        ...
        logURL = logsDir.appendingPathComponent("Logs/kshr-update.log")
        ensureLogFile()
    }
...
final class FocusLogStore {
    ...
    private let queue = DispatchQueue(label: "kshr.focus.log")
    private var entries: [String] = []
    ...
    private init() {
        ...
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first
            ?? FileManager.default.temporaryDirectory
        logURL = logsDir.appendingPathComponent("Logs/kshr-focus.log")
        ensureLogFile()
    }
