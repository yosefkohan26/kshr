...
private let kshrAppIconDidChangeNotification = Notification.Name("com.kshrterm.appIconDidChange")
private let kshrAppIconModeKey = "appIconMode"
...
final class KshrDockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    func setDockTile(_ dockTile: NSDockTile?) {
        ...
        iconChangeObserver = DistributedNotificationCenter.default().addObserver(
            forName: kshrAppIconDidChangeNotification,
            object: nil,
            queue: nil
        ) { [weak self] _ in
