...
struct GhosttyConfig {
    ...
    private static let kshrReleaseBundleIdentifier = "com.kshrterm.app"
    ...
    private static func kshrConfigPaths(
        ...
        let releasePaths = paths(for: kshrReleaseBundleIdentifier)
        guard let currentBundleIdentifier, !currentBundleIdentifier.isEmpty else {
            return releasePaths
        }
        if currentBundleIdentifier == kshrReleaseBundleIdentifier {
            return releasePaths
        }
    ...
    private static func loadFromDisk(preferredColorScheme: ColorSchemePreference) -> GhosttyConfig {
        ...
        ].map { NSString(string: $0).expandingTildeInPath } + kshrConfigPaths()
