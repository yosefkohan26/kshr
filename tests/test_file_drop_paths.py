...
def wait_for_text(client: kshr, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "kshr drop [image] #1 (a).png").resolve()
    p2 = (tmp / "kshr drop second & file!.jpg").resolve()
