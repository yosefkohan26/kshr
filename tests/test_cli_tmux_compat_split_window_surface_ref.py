#!/usr/bin/env python3
"""
Regression tests for `kshr __tmux-compat split-window`.
"""
...
def run_cli(
    ...
    env["KSHR_WORKSPACE_ID"] = "workspace:1"
    env["KSHR_SURFACE_ID"] = "surface:1"
...
def main() -> int:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="kshr-tmux-surface-ref-") as td:
            tmp = Path(td)
