#!/usr/bin/env python3
"""
Regression test: `kshr claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="kshr-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `kshr claude-teams --help` exited non-zero")
    ...
    print("PASS: kshr claude-teams forwards --help to Claude")
    return 0
