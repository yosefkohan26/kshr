...
def _find_cli_binary() -> str:
    ...
    fixed = os.path.expanduser(
        "~/Library/Developer/Xcode/DerivedData/kshr-tests-v2/Build/Products/Debug/kshr"
    )
...
<!doctype html>
<html>
  <head><title>kshr-browser-cli-regression</title></head>
  <body>
    <main>
...
""".strip()
        ...
        out_dir = Path(tempfile.mkdtemp(prefix="kshr-browser-screenshot-cli-")) / "nested" / "dir"
