...
- use a v2 JSON client (`tests_v2/kshr.py`)
- avoid depending on v1 text output formats

VM runners:
- v1: `ssh kshr-vm 'cd /Users/kshr/GhosttyTabs && ./scripts/run-tests-v1.sh'`
- v2: `ssh kshr-vm 'cd /Users/kshr/GhosttyTabs && ./scripts/run-tests-v2.sh'`
