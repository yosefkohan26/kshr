...
final class SidebarBranchOrderingTests: XCTestCase {
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 337,
                    label: "PR",
                    url: "https://github.com/yosefkohan26/kshr/pull/337",
                    status: .open
                ),
                second: pullRequestState(
                    number: 18,
                    label: "MR",
                    url: "https://gitlab.com/yosefkohan26/kshr/-/merge_requests/18",
                    status: .open
                ),
                ...
                fourth: pullRequestState(
                    number: 92,
                    label: "PR",
                    url: "https://bitbucket.org/yosefkohan26/kshr/pull-requests/92",
                    status: .closed
                )
            ],
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 42,
                    label: "PR",
                    url: "https://github.com/yosefkohan26/kshr/pull/42",
                    status: .open
                ),
                second: pullRequestState(
                    number: 42,
                    label: "MR",
                    url: "https://gitlab.com/yosefkohan26/kshr/-/merge_requests/42",
                    status: .open
                )
            ],
    ...
    func testOrderedUniquePullRequestsTreatsSameNumberAndLabelDifferentUrlsAsDistinct() {
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                ...
                second: pullRequestState(
                    number: 42,
                    label: "PR",
                    url: "https://github.com/yosefkohan26/other-repo/pull/42",
                    status: .open
                )
            ],
            fallbackPullRequest: nil
        ...
        XCTAssertEqual(
            ...
            [
                "https://github.com/yosefkohan26/kshr/pull/42",
                "https://github.com/yosefkohan26/other-repo/pull/42"
            ]
        )
    }
    ...
    func testUpdatePanelPullRequestPreservesExistingChecksWhenUpdateOmitsThem() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 42,
            label: "PR",
            url: URL(string: "https://github.com/yosefkohan26/kshr/pull/42")!,
            status: .open,
            checks: .pass
        )
        workspace.updatePanelPullRequest(
    ...
    func testOrderedUniquePullRequestsUsesFallbackWhenNoPanelPullRequestsExist() {
        let fallback = pullRequestState(
            number: 11,
            label: "PR",
            url: "https://github.com/yosefkohan26/kshr/pull/11",
            status: .open
        )
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            orderedPanelIds: [],
...
final class TerminalControllerSidebarDedupeTests: XCTestCase {
    ...
    func testNormalizeReportedDirectoryTrimsWhitespace() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("   /Users/kshr/project   "),
            "/Users/kshr/project"
        )
    }
    ...
    func testNormalizeReportedDirectoryResolvesFileURL() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("file:///Users/kshr/project"),
            "/Users/kshr/project"
        )
    }
