...
final class KeyboardShortcutSettingsFileStoreTests: XCTestCase {
    ...
    private let settingsFileBackupsDefaultsKey = "kshr.settingsFile.backups.v1"
    ...
    func testBootstrapCreatesCommentedTemplateWhenPrimaryAndFallbackAreMissing() throws {
        ...
        let settingsFileURL = directoryURL
            .appendingPathComponent(".config/kshr", isDirectory: true)
        ...
        XCTAssertTrue(contents.contains(#""$schema": "https://raw.githubusercontent.com/yosefkohan26/kshr/main/web/data/kshr-settings.schema.json""#))
    ...
    func testSettingsFileStoreParsesJSONCCommentsAndTrailingCommas() throws {
        ...
        try writeSettingsFile(
            """
            {
              "$schema": "https://raw.githubusercontent.com/yosefkohan26/kshr/main/web/data/kshr-settings.schema.json",
              "schemaVersion": 1,
              // tmux-like prefix
              "shortcuts": {
                "bindings": {
...
final class WorkspaceCreationConfigSanitizationTests: XCTestCase {
    private final class UnsafeConfigSnapshotTabManager: TabManager {
        private var injectedConfig: KshrSurfaceConfigTemplate?
        var capturedConfigTemplate: KshrSurfaceConfigTemplate?

        func installInjectedConfig(fontSize: Float) {
            var config = KshrSurfaceConfigTemplate()
            config.fontSize = fontSize
            config.workingDirectory = "/tmp/kshr-workspace-snapshot"
            config.command = "echo snapshot"
            config.environmentVariables = ["KSHR_INHERITED_ENV": "1"]
...
final class WorkspaceSplitWorkingDirectoryTests: XCTestCase {
    ...
    func testNewTerminalSplitFallsBackToRequestedWorkingDirectoryWhenReportedDirectoryIsStale() {
        ...
        let requestedDirectory = "/tmp/kshr-requested-split-cwd-\(UUID().uuidString)"
...
final class WorkspacePanelGitBranchTests: XCTestCase {
    ...
    func testUpdatingFocusedPanelPullRequestWithSameStateDoesNotRepublishWorkspace() {
        ...
        let pullRequestURL = URL(string: "https://github.com/yosefkohan26/kshr/pull/2388")!
    ...
    func testSidebarObservationPublisherIgnoresRemoteHeartbeatOnlyChanges() {
        ...
        workspace.telemetry.remoteHeartbeatCount = 1
        workspace.telemetry.remoteLastHeartbeatAt = Date()
    ...
    func testSidebarPullRequestsTrackFocusedPanelOnly() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 1629,
            label: "PR",
            url: URL(string: "https://github.com/yosefkohan26/kshr/pull/1629")!,
            status: .open
        )
    ...
    func testSidebarDerivedCollectionsMatchWhenUsingPrecomputedPanelOrder() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 101,
            label: "PR",
            url: URL(string: "https://github.com/yosefkohan26/kshr/pull/101")!,
            status: .open
        )
        workspace.updatePanelPullRequest(
            ...
            number: 18,
            label: "MR",
            url: URL(string: "https://gitlab.com/yosefkohan26/kshr/-/merge_requests/18")!,
            status: .merged
        )
